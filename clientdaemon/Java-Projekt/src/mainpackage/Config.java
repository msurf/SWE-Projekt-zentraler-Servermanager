...
public class Config {
	...
	public synchronized String isBusy(){ return ((this._busy <= 0) ? "on":("busy:"+this._busy));}
	...
	public synchronized void getSys(){
		...
		{
			System.out.println("Error: No Hardwareinfos collected! Please check!");
		}
	...
	public synchronized void writeConfig(){
		...
		{
			System.out.println("Error: Could not write Config! Please Check!");
		}
	...
	public synchronized String swinfo(){
		String tmp = "none";
		if(this._softwareStatus.size() > 1){
